...
public class RedScreenGlichEffectRenderer {
    ...
    private static void renderGlichOverlay(GuiGraphics graphics, int amplifier) {
        ...
        for (int i = 0; i < numberOfLines; i++) {
            ...
            int startX = (int) (width * (Math.random() * 0.7)); // Todas las líneas comienzan desde un lugar aleatorio.
            int endX = (int) (width * (0.8 + Math.random() * 0.2)); // Longitud de la línea.
